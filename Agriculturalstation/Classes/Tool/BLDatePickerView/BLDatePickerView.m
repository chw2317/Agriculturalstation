...
- (void)setUpYMDateDic{
    ...
    for (NSInteger i = 1; i <= 12; i++) {
        if(i < 10){
            [_monthArray addObject:[NSString stringWithFormat:@"0%ld",(long)i]];
        }else{
...
- (void)bl_setUpDefaultDateWithYear:(NSInteger)year
    ...
    if(month < 10){
        monthTitle = [NSString stringWithFormat:@"0%ld",(long)month];
    }else{
        monthTitle = [NSString stringWithFormat:@"%ld",(long)month];
    }
    if(day < 10){
        dayTitle = [NSString stringWithFormat:@"0%ld",(long)day];
    }else{
        dayTitle = [NSString stringWithFormat:@"%ld",(long)day];
    }
//    NSString *monthTitle = [NSString stringWithFormat:@"%ld",(long)month];
