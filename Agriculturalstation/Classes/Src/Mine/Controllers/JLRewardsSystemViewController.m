...
//    titleLabel.text = @"奖罚制度";
    ...
    // 请求地址
    NSString *url = [REQUEST_URL stringByAppendingString:@"app-personalinfo-op-regime.html"];
    // 请求管理者
    ...
    [manager POST:url parameters:nil progress:^(NSProgress *_Nonnull uploadProgress){
        ...
        // 显示HTML文本
        NSAttributedString *attrStr = [[NSAttributedString alloc] initWithData:[responseObject[@"content"] dataUsingEncoding:NSUnicodeStringEncoding] options:@{NSDocumentTypeDocumentAttribute:NSHTMLTextDocumentType} documentAttributes:nil error:nil];
